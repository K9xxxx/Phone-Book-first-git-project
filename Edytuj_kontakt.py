...
"""Blok kodu odpowiadajacy za wyswietlanie kontaktow w programie"""
...
# _nr_tele=Dodaj_kontakt.dodaj_nr_tel()      #Do usuniecia (zrobione w lepszy sposob pod spodem
# _imie=Dodaj_kontakt.dodaj_imie()           #wywolanie funckcji jako argument
